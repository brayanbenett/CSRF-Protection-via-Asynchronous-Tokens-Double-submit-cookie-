...
<h1 style="font-size: 35px;text-align:center;color: #dff9fb;">Secure Software Systems</h1>
    ...
    <p style="text-align:center;color: #95afc0">For more Info: <a href="https://github.com/brayanbenett/CSRF-Protection-via-Asynchronous-Tokens-Double-submit-cookie-">Brayan Benett</a></p>
</div>
